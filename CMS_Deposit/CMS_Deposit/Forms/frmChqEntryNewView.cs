...
namespace CMS_Deposit.Forms
{
    public partial class frmChqEntryView : Form
    {
        ...
        public frmChqEntryView(CMSEntities.ChqEntry_Model _ChqEntry)
        {
            ...
            txtMicrCode.Text = ObjChqEntry.micr_code;
            txtTranCode.Text = ObjChqEntry.tran_code;
        ...
        private void btnadd1_Click(object sender, EventArgs e)
        {
            ...
            txtMicrCode.Text = txtMicrCode.Text.Trim();
            txtTranCode.Text = txtTranCode.Text.Trim();
            ...
            if (txtMicrCode.Text == "" || txtMicrCode.Text.Length != 9)
            {
                MessageBox.Show("Invalid micr code !", global_variable.proj_name, MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtMicrCode.Focus();
                return;
            }

            if (txtTranCode.Text == "" || txtTranCode.Text.Length != 2)
            {
                MessageBox.Show("Invalid tran code !", global_variable.proj_name, MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtTranCode.Focus();
                return;
            }
            ...
            ObjChqEntry.micr_code = txtMicrCode.Text;
            ObjChqEntry.tran_code = txtTranCode.Text;
            ObjChqEntry.ref_no = "";
            ...
            string[] result = ObjCmsBusiness.SaveCMSNewEntry(ObjChqEntry);

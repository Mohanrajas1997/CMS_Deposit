    ...
    public partial class frmChqView : Form
    {
        ...
        private void GetChqEntryView()
        {
            ...
            if (DepositGid > 0)
            {
                ...
                dtChequeQ = ObjCmsBusiness.GetChqEntryNewView(DepositGid);
        ...
        private void set_grid_datacolumn_dipositQ()
        {
            if (dtChequeQ.Columns.Count == 0)
            {
                ...
                dtChequeQ.Columns.Add("micr_code", typeof(string));
                dtChequeQ.Columns.Add("tran_code", typeof(string));
            }
        ...
        private void gvchqview_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex >= 0)
            {
                if (gvchqview.Columns[e.ColumnIndex].Name == "edit")
                {
                    ...
                    ObjChqDtls.micr_code = gvchqview.CurrentRow.Cells["micr_code"].Value.ToString();
                    ObjChqDtls.tran_code = gvchqview.CurrentRow.Cells["tran_code"].Value.ToString();
                ...
                else if (gvchqview.Columns[e.ColumnIndex].Name == "delete")
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        CMSEntryBusiness ObjCmsBusiness = new CMSEntryBusiness();
                        string[] result_dtl = ObjCmsBusiness.SaveCMSNewEntry(ObjChqHdr);

...
{
    public partial class frmUploadRpt : Form
    {
        ...
        private void btnref_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (txtUploadNo.Text != "")
                {
                    ConditionStatus += " and a.upload_sno = '" + txtUploadNo.Text + "' ";
                }
                if (txtUploadCode.Text != "")
                {
                    ConditionStatus += " and a.upload_code = '" + txtUploadCode.Text + "' ";
                }
                ...
                dt = Obj.GetUploadRpt(ConditionStatus);
        ...
        private void btnexport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                workbook.SaveAs(root + "Upload Report" + ".xls", Type.Missing, Type.Missing, Type.Missing, Type.Missing, Type.Missing, Microsoft.Office.Interop.Excel.XlSaveAsAccessMode.xlExclusive, Type.Missing, Type.Missing, Type.Missing, Type.Missing);
